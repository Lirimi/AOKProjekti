...
module SLL(output reg[15:0] sll, input[15:0] s, input[15:0] l);

always@(s or l)
begin

assign sll = {s[15], 1'b0};               // shift s  left by 1 bit
assign sll = {s[14], l[15]};              // shift s  left by 1 bit
...
module SRL(output reg[15:0] srl, input[15:0] s, input[15:0] l);


always@(s or l)
begin
assign srl = {s[15], l[14]};               // shift s  right by 1 bit
